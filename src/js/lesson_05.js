...
//   this.price = price;
// }
// const Audi = new Car('Audi', 'Q7', 40000);
// console.log(Audi);
...
//   this.price = price;
// }
// const Audi = new Car({ brand: 'Audi', model: 'Q7', price: 48000 });
// console.log(Audi);
...
// function Car({ brand, model, price = 10 }) { //10 - для наглядности, что ф-ция работает
//   this.brand = brand;
//   this.model = model;
//   this.price = price;
// }
...
//   this.price = newPrice;
// };
// const Audi = new Car({ brand: 'Audi', model: 'Q3', price: 348000 });
// console.log(Audi);
