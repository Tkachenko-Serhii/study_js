...
// }
// console.log(makeMessage('Итальяно', makePizza));
// console.log(makeMessage('Итальяно', deliverPizza));
...
//   order(pizzaName, onSaccess, onError) {
//     for (let pizza of this.pizzas) {
//       if (pizza === pizzaName) {
//         return onSaccess(pizza);
//       }
//     }
...
//   return `Готовим ${this.dish} для ${this.email}. Ваш заказ ${position}-й в очерди.`;
// }
// const messages = [];
